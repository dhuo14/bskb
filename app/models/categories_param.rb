	...
	def self.xml(who='',options={})
	  %Q{
	    ...
	    <root>
	    	...
	    	<node name='参数类型' column='data_type' data_type='select' class='required' data='[["text","文本类型"],["radio","单选"],["checkbox","多选"],["select","下拉单选"],["multiple_select","下拉多选"],["textarea","大文本类型"],["richtext","富文本类型"],["hidden","隐藏类型"]]'/>
	    	<node name='参数格式' column='rule' data_type='select' data='[["text","字符类型"],["email","电子邮件类型"],["url","网址类型"],["date","日期类型"],["dateISO","日期类型(YYYY-MM-DD)"],["number","数字类型"],["digits","整数类型"]]'/>
