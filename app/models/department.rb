  ...
  include AboutAncestry
	...
	def self.xml(who='',options={})
	  %Q{
	    ...
	    <root>
	      <node name='单位名称' column='name' hint='必须与参照营业执照中的单位名称保持一致' rules='{required:true, maxlength:10, minlength:5}'/>
	      ...
	      <node name='是否保密单位' column='is_secret' data_type='radio' data='是|否'/>
